...
**기술 스택:**
- Frontend: Next.js 14, TypeScript, Tailwind CSS, Amplify
- Backend: AWS Lambda, Step Functions, DynamoDB, Api Gateway, OpenSearch 
- AI: AWS Bedrock (Claude 3.5)
- API: 네이버 쇼핑 API
- Infrastructure: AWS CloudFormation, S3
